export default function Workflow() {
    return(
        <main className="bg-ab-accent pt-8 flex flex-col items-center">
            ...
            <h1 className="text-center uppercase mt-4 text-xl">email me: <a href="mailto:abigayleugc@gmail.com<s">abigayleugc@gmail.com</a></h1>
        </main>
    )
}
