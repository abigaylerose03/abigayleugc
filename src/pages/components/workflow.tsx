export default function Workflow() {
    return(
        <main className="bg-ab-accent flex flex-col items-center">
            <h1 className="text-ab-page mt-8 text-center uppercase text-4xl font-unbounded mb-8">My Workflow</h1>
            <h2 className="text-center uppercase text-2xl mb-8 font-nunito">Seamless Collaboration Abigayle x Brand</h2>
            {/* 2 column grid */}
            ...
            <div className="text-center mt-8 text-xl uppercase">
                <h1 className="text-2xl font-bold underline">Investment Requirements</h1>
            ...
            <h1 className="text-center uppercase my-4 text-xl font-nunito">email me: <a className="underline lowercase" href="mailto:abigayleugc@gmail.com<s">abigayleugc@gmail.com</a></h1>
        </main>
    )
}
