    ...
    return (
        ...
        <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            ...
            return (
                ...
                <svg fill="#A6988B" className="w-60 h-60 sm:w-48 sm:h-48 md:w-56 md:h-56 lg:w-64 lg:h-64" version="1.1" viewBox="0 0 184.751 184.751">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"/>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"/>
                    <g id="SVGRepo_iconCarrier"> 
                    <path d="M0,92.375l46.188-80h92.378l46.185,80l-46.185,80H46.188L0,92.375z"/>
                    {lines.map((line, lineIndex) => (
                        <text key={lineIndex} x="50%" y={`${startY + lineIndex * 20}%`} textAnchor="middle" fill="black" className='uppercase text-black font-bold'>{line}</text>
                    ))}
                    </g>
                </svg>
                </div>
        ...
        <h3 className='my-8 text-center text-2xl'>
            Content that creates <span className='italic'>authentic</span> portrayals of your brand, increasing retention and engagment <span className='italic'>speedily.</span>
        </h3>
