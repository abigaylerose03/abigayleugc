...
export default function Services() {
    return (
        <main className="mt-8">
            <h1 className="text-ab-accent text-center uppercase text-5xl mb-8">My Services</h1>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
                ...
                <div className="flex flex-col items-center text-center uppercase">
                    ...
                    <p className="mb-4">I create ads that effectively lead to increased conversions and sales.</p>
                ...
                <div className="flex flex-col items-center text-center uppercase">
                    ...
                    <div className="text-xl">
                    <p className="mb-4">I create aesthetic photos that don't compromise on ROI</p>
                    <p className="mb-2">This Includes:</p>
                    <ul>
                        <li>Ideation Process</li>
                        <li>Raw Images</li>
